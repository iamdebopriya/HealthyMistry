...
# Streamlit UI
st.markdown('<h1 class="app-title">HealthyMistry</h1>', unsafe_allow_html=True)
st.markdown('<p class="catchline">Your Health Assistant – Quick and Easy Disease Prediction</p>', unsafe_allow_html=True)
